...
use Byte5\LaravelHarvest\Models\Reports\Time\Project\Result;
use Byte5\LaravelHarvest\Test\Fakes\FakeApiResponse;
use Byte5\LaravelHarvest\Test\TestCase;
use Illuminate\Support\Collection;

class TransformReportsTimeProjectTest extends TestCase
{
    /** @test **/
    public function it_can_transform_reports_api_responses_into_their_corresponding_models()
    {
        ...
        $this->assertSame($json['results'][0]['project_id'], $collection->first()->external_project_id);
        $this->assertSame($json['results'][1]['project_id'], $collection->get(1)->external_project_id);
    }
